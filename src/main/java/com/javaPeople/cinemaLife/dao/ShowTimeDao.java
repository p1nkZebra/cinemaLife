...
public class ShowTimeDao {
    ...
    public List<ShowTimeDto> findShowTimeDtosBetweenDateTimes(Timestamp dateTimeFrom,
        ...
        try {
            ...
            sql = "   SELECT a.*, b.name as film_name, c.name as screen_name, d.name as cinema_name " +
            ...
            while (resultSet.next()) {
                ...
                ShowTimeDto showTimeDto = new ShowTimeDto(id, filmName, screenName, cinemaName, dateTime.toLocalDateTime());
...
//    public List<ShowTimeDto> findShowTimeDtosByCinema(Timestamp dateTimeFrom,
//                                                              Timestamp dateTimeTo) {
//
//
//        List<ShowTimeDto> showTimeList = new ArrayList<>();
